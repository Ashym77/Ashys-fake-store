  ...
  if (arrayItems.length !== 0) {
    for (let i = 0; i < arrayItems.length; i++) {
      cartsectionEl.innerHTML += `
            ...
            <br>
            <br>
            <img onclick="removeitem(${i})" src="trash-can.png" alt="icon of trash can" class="delete-icon">
...
function additem() {
  ...
  fetch(
    "https://firestore.googleapis.com/v1/projects/ashkans-da1e8/databases/(default)/documents/shop",
    {
      method: "POST",
      headers: {
